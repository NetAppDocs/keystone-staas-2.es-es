...
NOTE: Si te has suscrito a servicios complementarios como la protección avanzada de datos (ADP) o Data Infrastructure Insights (DII), los datos de consumo de estos servicios aparecen junto a tus niveles de servicio de rendimiento base tanto en el consumo histórico como en las vistas de ráfagas acumuladas. Para saber más sobre los servicios complementarios, consulta link:../concepts/adp.html["Obtenga más información sobre los servicios complementarios"] image:consumption-trend-burst.png["captura de pantalla que muestra el consumo histórico"]
...
** *Por encima de la capacidad de ráfaga*: Consumo de almacenamiento por encima del límite de ráfaga. Esta métrica solo aparece cuando se supera el límite de ráfaga.
+
...
Puedes ver el uso de capacidad proyectado para los próximos 120 días a partir de la fecha actual usando el interruptor *Forecast* disponible en la vista *Historical consumption* de la pestaña *Consumption trend* en la Console. El interruptor está activado por defecto.

Por defecto, el gráfico muestra los últimos 30 días de consumo histórico y una proyección de 120 días a partir de la fecha actual en el mismo gráfico. Se trazan hasta 30 puntos de datos en total (20 para datos históricos y 10 para datos de previsión), con una línea vertical que separa los dos segmentos.
...
También puedes descargar los datos en formato Excel, incluyendo el estado de las ráfagas (facturadas, no facturadas o provisionales) y la facturación por
