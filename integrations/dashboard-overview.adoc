...
* Aunque la Console y Digital Advisor ofrecen algunas funciones exclusivas, la Console proporciona funcionalidad administrativa para Keystone, permitiéndote gestionar suscripciones y hacer los ajustes necesarios. Para saber más, consulta link:https://docs.netapp.com/us-en/console-setup-admin/reference-iam-keystone-roles.html["Roles de acceso de Keystone en la NetApp Console"^].
...
| *Característica* | * Consola NetApp * | * Digital Advisor* 
