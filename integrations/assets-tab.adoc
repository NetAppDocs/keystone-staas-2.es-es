...
+
Ves la información detallada sobre los volúmenes en los clústeres, incluyendo el nombre del volumen, el número de serie del nodo, el cumplimiento con las políticas de QoS, el nombre del clúster, el nombre de host y los niveles de servicio de rendimiento. También puedes monitorear la capacidad aprovisionada, la utilización lógica y física, los datos fríos y los datos calientes.
