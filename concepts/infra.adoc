...
Puede ver los detalles de suscripción y consumo de sus suscripciones de Keystone a través de la consola de NetApp o Digital Advisor. Para obtener más información sobre los informes de Keystone , consultelink:../integrations/dashboard-overview.html["Descripción general del panel de control de Keystone"] .
