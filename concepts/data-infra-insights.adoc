...
Para configurar DII, consulta link:https://docs.netapp.com/us-en/data-infrastructure-insights/task_getting_started_with_cloud_insights.html["Incorporación de Data Infrastructure Insights"^].
