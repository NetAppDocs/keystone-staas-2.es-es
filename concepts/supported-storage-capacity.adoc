...
Esta es la capacidad de almacenamiento necesaria para almacenar los datos de los usuarios antes de que se apliquen las eficiencias de datos que ofrece la matriz de almacenamiento.
